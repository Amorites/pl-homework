...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (snd (apair (add (int 9) (int 1)) (int 2)))) (int 2) "snd test2")
   ...
   (check-equal? (eval-exp (mlet* (list (cons "x!!" (int 10)) (cons "y!!" (add (var "x!!") (int 5))) ) (var "y!!"))) (int 15) "mlet* test")
   
   ;; ifeq test
   (check-equal? (eval-exp (ifeq (int 1) (int 2) (int 3) (int 4))) (int 4) "ifeq test")

   (check-equal? (eval-exp (ifeq (begin (print "hello") (add (int 0) (int 1))) (int 2) (int 3) (int 4))) (int 4) "ifeq test")
